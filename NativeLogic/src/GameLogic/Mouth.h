...
#define MOUTH_MOUTH_TRANSLATE	T6Vec3(0.0f, 160.0f, 0.0f)
#define MOUTH_STATIC_BASE_TRANSLATE	T6Vec2(0.0f, 0.0f)
#define MOUTH_LIVING_BASE_TRANSLATE	T6Vec2(0.0f, -22.0f)
#define MOUTH_HEAD_TRANSLATE	T6Vec2(0.0f, -30.0f)
...
#define MOUTH_TENTACLE_L_POS_FIX	T6Vec3(-51.0f, -41.0f, 0.0f)
#define MOUTH_TENTACLE_R_POS_FIX	T6Vec3(51.0f, -41.0f, 0.0f)
...
{
public:
	Mouth(T6Vec3 pos, Object* player);
	virtual ~Mouth();
...
private:
	...
	T6_MergedTexture* head_;
	int currentEyeColorIndex_;
	DWORD timeCounter_;
	T6Vec3 basePos_;
	Object* target_;
	DWORD opacity_;
