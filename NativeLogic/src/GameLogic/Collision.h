...
public:
	...
	static CollisEvent* isStandingOnSomething(vector<CollisEvent*>* collisEvents, T6Rect* objectRect = nullptr, vector<Object*>* exceptionTiles = nullptr)
	{
...
public:
	...
	static double checkCollision(Object* ob1, Object* ob2, Direction* out_CollisDirect)
	{
		...
		T6Vec3 velocity = convertVelocity(ob1, ob2);
...
private:
	...
	{
		T6Vec3 distance(Collision::distanceX(ob1, ob2), Collision::distanceY(ob1, ob2), 0.0F);
	...
	// =======================================
	static T6Vec3 convertVelocity(Object* ob1, Object* ob2)
	{
		T6Vec3 result;
	...
	// =======================================
	static double collisAABB(Object* ob1, Object* ob2, T6Vec3 velocity_ob1, Direction* out_CollisDirect)
	{
		T6Rect rect1 = ob1->getRect();
		T6Rect rect2 = ob2->getRect();

		T6Vec3 trueSpeed = TRUE_SPEED(velocity_ob1, (float)Timer::getRoundTime());
		...
		T6Vec3 distance(distanceX(ob1, ob2), distanceY(ob1, ob2), 0.0F);
		T6Vec3 time(0, 0, 0);
