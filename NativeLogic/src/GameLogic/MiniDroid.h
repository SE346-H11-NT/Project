...
#define MINI_DROID_MOVE_SPEED_X(scaleX)	(T6Vec3(60.0F * scaleX, 0.0F, 0.0F))
#define MINI_DROID_MOVE_SPEED_Y			(T6Vec3(0.0F, -60.0F, 0.0F))
...
{
public:
	MiniDroid(T6Vec3 pos, T6Vec2 scale);
	virtual ~MiniDroid();
