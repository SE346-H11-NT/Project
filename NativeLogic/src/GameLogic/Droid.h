...
#define DROID_FIRE_TRANSLATE		T6Vec2(0.0F, -15.0F)
...
#define DROID_DOOR_TRANSLATE		T6Vec2(0.0F, -37.0F)
...
#define DROID_START_POS_FIX		T6Vec3(-114.0F, 114.0F, 0.0F)
#define DROID_GENERATE_TIME		(MINI_DROID_WAIT_TIME * 7)
#define DROID_GENERATE_DELAY	(MINI_DROID_WAIT_TIME)
#define DROID_MINI_GENERATE_POS_FIX(side)	(T6Vec3(side == Side::SIDE_LEFT ? -22.0F : 22.0F, 45.0F, 0.0F))
#define DROID_FIRE_GENERATE_POS_FIX	(T6Vec3(0.0F, 45.0F, 0.0F))
