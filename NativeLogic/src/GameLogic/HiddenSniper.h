#ifndef HiddenSniper_h__
#define HiddenSniper_h__
...
#define HIDDEN_SNIPER_DIT6RectION_MEASURE(numOfDirection)	(360 / numOfDirection)
...
{
public:
	HiddenSniper(T6Vec3 position, Object* target, Size visiblePercent, int numOfShootDirection);
...
private:
	...
	Size visiblePercent_;

	int numOfShootDirection_;
};
